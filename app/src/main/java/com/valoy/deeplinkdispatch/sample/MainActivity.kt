...
import com.valoy.deeplinkdispatch.R

@DeepLink(
    "dld://classDeepLink",
    "http://valoydeeplink.com/foo{arg_end}",
    "http://valoydeeplink.com/{arg_start}bar",
    "dld://valoydeeplink.com/deepLink",
    "https://www.valoydeeplink.com/<configurable-path-segment>/bar",
    "https://www.valoydeeplink.com/<configurable-path-segment-one>/<configurable-path-segment-two>/foo",
    "https://www.valoydeeplink.com/cereal/<configurable-path-segment>",
    "https://www.valoydeeplink.com/nothing-special"
)
...
object MainActivityDeeplinks {
     ...
     */
    @DeepLink("http://valoydeeplink.com/deepLink/{id}/{name}/{place}")
    @JvmStatic
